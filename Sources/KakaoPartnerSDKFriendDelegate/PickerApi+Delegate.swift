...
extension PickerApi {
    ...
    public func multiChatMemberPickerView(
        ...
        setup(targetInfo: targetInfo)
        PickerApi.shared.____mmv(params: params.toFriendRequestParams(), chatId: chatId, friendsOnly: friendsOnly) { [weak self] pickerView, responseInfo, error in
            completion(pickerView, self?.castSdkError(responseInfo: responseInfo, error: error))
        }
    }
    ...
    public func singleFriendPickerViewByUuids(params: PickerFriendRequestParams, targetInfo: TargetInfo, uuids: [String], completion: @escaping (PickerView?, Error?) -> Void) {
        setup(targetInfo: targetInfo)
        
        PickerApi.shared.____fspv(params: params, uuids: uuids) { [weak self] pickerView, responseInfo, error in
            completion(pickerView, self?.castSdkError(responseInfo: responseInfo, error: error))
        }
    }
    ...
    public func multiFriendPickerViewByUuids(params: PickerFriendRequestParams, targetInfo: TargetInfo, uuids: [String], completion: @escaping (PickerView?, Error?) -> Void) {
        setup(targetInfo: targetInfo)
        
        PickerApi.shared.____fmpv(params: params, uuids: uuids) { [weak self] pickerView, responseInfo, error in
            completion(pickerView, self?.castSdkError(responseInfo: responseInfo, error: error))
        }
    }
}
